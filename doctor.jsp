...
<ul>
  ...
  <li><a href="<%=request.getContextPath()%>/CatalogueServlet">Catalogue</a></li>
...
<!-- Profile Information -->
 <div class="container">
    ...
    <% Object department1 = session.getAttribute("department"); %>
      <label style="color:white" class="container"><% out.print(department1); %> </label>      
    <br>
    <br>
